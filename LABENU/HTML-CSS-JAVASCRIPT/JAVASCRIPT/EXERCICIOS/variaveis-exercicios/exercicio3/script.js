...
let dataDeNascimento = prompt(
  "Digite sua data de nascimento-> utilize o / para separar dd / mm / yy: "
);
...
let comissao = confirm(
  "Recebe comissão? Se sim, aperte em confirme, caso não, clique em cancel"
);
